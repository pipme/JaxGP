...
from gpjax.types import JAXArray
...
class Distance:
    ...
    def squared_distance(self, X1: JAXArray, X2: JAXArray) -> JAXArray:
        ...
        :func:`gpjax.kernels.stationary.Distance.distance`, but some metrics
...
class Stationary(Kernel):
    ...
    :class:`gpjax.transforms.Linear` or :class:`gpjax.transforms.Cholesky`.
    ...
    Args:
        ...
        distance: An object that implements ``distance`` and
            ...
            :class:`gpjax.kernels.stationary.Distance`. Each stationary kernel
